...
const { title, description, shortDescription, points, index } = defineProps<{
  title: string,
  // image: string,
  description: string,
...
<template>
  ...
  <!-- Main modal -->
  <div :id="'modal-informacion-' + index" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full animate-fade-down animate-duration-700">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
      ...
      <div class="relatived bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
          ...
          <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" :data-modal-hide="'modal-informacion-' + index">
