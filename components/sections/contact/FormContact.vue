<template>
  <section>
    <form>
      <div class="grid lg:grid-cols-1 gap-6 mb-6 md:grid-cols-1">
        <div>
        ...
        <div>
          <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mensaje</label>
