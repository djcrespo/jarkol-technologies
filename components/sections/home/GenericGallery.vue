...
<template>
  <AtomsContainer class-name="relative">
    <div id="custom-controls-gallery" class="relative w-full lg:pt-10" data-carousel="slide">
      <!-- Carousel wrapper -->
      <div class="relative h-full lg:h-full overflow-hidden rounded-lg md:h-56">
        <!-- Item 1 -->
