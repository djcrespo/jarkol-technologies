<template>
    <footer class="bg-gray-100 dark:bg-body border-t border-gray-200 dark:border-gray-100/20">
      <div class="py-10">
        <div class="grid lg:grid-cols-3 md:grid-cols-1 md:py-2">
          ...
          <div class="flex justify-center gap-x-3 md:py-2">
            <NuxtLink target="_blank" to="https://www.facebook.com/JarkolTech" class="transition hover:!text-primary">
            ...
            <NuxtLink target="_blank" to="https://api.whatsapp.com/send?phone=529931603161" class="transition hover:!text-primary">
